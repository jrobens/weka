...
public class MLRClassifier extends RandomizableClassifier
  ...
  //public static final int R_CLASSIF_GEODA = 19; // new: DiscriMiner, geoDA DiscriMiner no longer on CRAN!
  public static final int R_CLASSIF_GLMBOOST = 19;
  public static final int R_CLASSIF_GLMNET = 20; // new: glmnet, glmnet
  //public static final int R_CLASSIF_H2O_DEEPLEARNING = 21; // new: h2o HBO learners hangs(Java 17?)
  ...
  public static final int R_CLASSIF_KKNN = 21;
  public static final int R_CLASSIF_KNN = 22; // new in 2.4(?): class, knn
  public static final int R_CLASSIF_KSVM = 23;
  public static final int R_CLASSIF_LDA = 24;
  public static final int R_CLASSIF_LIBLINEARL1L2SVC = 25; // new in 2.7(?): LiblineaR
  public static final int R_CLASSIF_LIBLINEARL1LOGREG = 26; // new in 2.7(?): LiblineaR
  public static final int R_CLASSIF_LIBLINEARL2L1SVC = 27; // new in 2.7(?): LiblineaR
  public static final int R_CLASSIF_LIBLINEARL2LOGREG = 28; // new in 2.7(?):LiblineaR
  public static final int R_CLASSIF_LIBLINEARL2SVC = 29; // new in 2.7(?): LiblineaR
  public static final int R_CLASSIF_LIBLINEARMULTICLASSSVC = 30; // new in 2.7(?): LiblineaR
  //public static final int R_CLASSIF_LINDA = 36; // new: DiscriMiner, linDA DiscriMiner no longer on CRAN!
  // public static final int R_CLASSIF_LIQUIDSVM = 37; not in MLR 2.17.1
  ...
  //public static final int R_CLASSIF_NODEHARVEST = 45; // new in 2.4(?)  no longer on CRAN
  public static final int R_CLASSIF_PAMR = 41; // new in 2.3: pamr, pamr
  public static final int R_CLASSIF_PENALIZED = 42; // factored into one scheme in 2.12(?): penalized
  ...
  //public static final int R_CLASSIF_QUADA = 52; // new: DiscriMiner, quaDA DiscriMiner no longer on CRAN!
  public static final int R_CLASSIF_RANDOM_FOREST = 47;
  public static final int R_CLASSIF_RANDOM_FOREST_SRC = 48; // new in 2.2: randomForestSRC
  public static final int R_CLASSIF_RANGER = 49; // new in 2.7(?): ranger
  public static final int R_CLASSIF_RDA = 50;
  public static final int R_CLASSIF_RFERNS = 51; // new in 2.4(?): rFerns, rFerns
  //public static final int R_CLASSIF_RKNN = 57; // new in 2.7(?): rknn no longer on CRAN!
  public static final int R_CLASSIF_ROTATIONFOREST = 52; // new in 2.7(?): rotationForest
  public static final int R_CLASSIF_RPART = 53;
  public static final int R_CLASSIF_RRF = 54; // new in 2.9: RRF
  //public static final int R_CLASSIF_RRLDA = 61; // new in 2.4(?): rrlda, rrlda rrlda no longer on CRAN!
  public static final int R_CLASSIF_SAEDNN = 55; // new in 2.7(?): deepnet
  public static final int R_CLASSIF_SDA = 56; // new in 2.2: sda, sda
  public static final int R_CLASSIF_SPARSELDA = 57; // new in 2.4(?): sparseLDA, MASS, elasticnet, sparseLDA NOTE: result probably not correct
  public static final int R_CLASSIF_SVM = 58;
  public static final int R_CLASSIF_XGBOOST = 59; // new in 2.7(?): xgboost

  // Regression
  public static final int R_REGR_BCART = 60; // new in 2.4(?): tgp, bcart
  public static final int R_REGR_BGP = 61; // new in 2.4(?): tgp, bgp
  public static final int R_REGR_BGPLLM = 62; // new in 2.4(?): tgp, bgpllm
  public static final int R_REGR_BLM = 63; // new in 2.4(?): tgp, blm
  public static final int R_REGR_BRNN = 64; // new in 2.4(?): brnn, brnn
  public static final int R_REGR_BST = 65; // new in 2.4(?): bst, bst
  public static final int R_REGR_BTGP = 66; // new in 2.4(?): tgp, btgp
  public static final int R_REGR_BTGPLLM = 67; // new in 2.4(?): tgp, btgpllm
  public static final int R_REGR_BTLM = 68; // new in 2.4(?): tgp, btlm
  public static final int R_REGR_CFOREST = 69; // new: party, cforest
  public static final int R_REGR_CRS = 70; // new: crs, crs
  public static final int R_REGR_CTREE = 71; // new in 2.2: party, ctree
  public static final int R_REGR_CUBIST = 72; // new in 2.4(?): Cubist, cubist
  public static final int R_REGR_CVGLMNET = 73; // new in 2.11(?): glmnet
  public static final int R_REGR_EARTH = 74;
  public static final int R_REGR_EVTREE = 75; // new in 2.11(?): evtree
  // public static final int R_REGR_FDBOOST = 87; // new in 2.12(?): FDboost,mboost FOR FUNCTIONAL DATA ONLY?
  public static final int R_REGR_FEATURELESS = 76; // new in 2.11(?): mlr
  public static final int R_REGR_FNN = 77;
  public static final int R_REGR_FRBS = 78; // new in 2.4(?): frbs, frbs
  public static final int R_REGR_GAMBOOST = 79; // new in 2.11(?): mboost
  public static final int R_REGR_GAUSSPR = 80; // new in 2.9: kernlab
  public static final int R_REGR_GBM = 81;
  public static final int R_REGR_GLM = 82; // new in 2.9(?): stats
  public static final int R_REGR_GLMBOOST = 83; // new in 2.7(?): mboost
  public static final int R_REGR_GLMNET = 84; // new: glmnet, glmnet
  public static final int R_REGR_GPFIT = 85; // new in 2.9: GPfit
  //public static final int R_REGR_H2O_DEEPLEARNING = 92; // new: h2o HBO learners hangs(Java 17?)
  //public static final int R_REGR_H2O_GBM = 93; // new: h2o
  //public static final int R_REGR_H2O_GLM = 94; // new: h2o
  //public static final int R_REGR_H2O_RANDOMFOREST = 95; // new: h2o
  ...
  // public static final int R_REGR_LIQUIDSVM = 108; not in MLR 2.17.1
  ...
  //public static final int R_REGR_NODEHARVEST = 106; // new in 2.4(?): nodeHarvest  no longer on CRAN
  public static final int R_REGR_PCR = 96; // new: pls, pcr
  public static final int R_REGR_PENALIZED = 97; // merged into one in 2.12(?): penalized
  public static final int R_REGR_PLSR = 98; // new in 2.2: pls, pls
  public static final int R_REGR_RANDOM_FOREST = 99;
  public static final int R_REGR_RANDOM_FOREST_SRC = 100; // new in 2.2: randomForestSRC
  public static final int R_REGR_RANGER = 101; // new in 2.7(?): ranger
  //public static final int R_REGR_RKNN = 113; // new in 2.7(?): rknn no longer on CRAN!
  public static final int R_REGR_RPART = 102;
  public static final int R_REGR_RRF = 103; // new in 2.9: RRF
  public static final int R_REGR_RSM = 104;
  public static final int R_REGR_RVM = 105;
  //public static final int R_REGR_SLIM = 125; // new in 2.4(?): flare, slim, not in MLR 2.17.1
  public static final int R_REGR_SVM = 106; // new: e1071, svm
  public static final int R_REGR_XGBOOST = 107; // new in 2.7(?): xgboost
  ...
  public String globalInfo() {
    return "A classifier that wraps the MLR package for R. It enables the use of many classifiers and regression methods in R. "
            + "This classifier is currently set up to work with version 2.17.1 or later of the MLR package. Please update the MLR package manually "
